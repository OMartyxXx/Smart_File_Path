...
def _read_current_version():
    """Lit la version depuis blender_manifest.toml pour avoir une seule source de vérité."""
    manifest_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "blender_manifest.toml")
    try:

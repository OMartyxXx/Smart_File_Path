bl_info = {
    "name": "SmartPath",
    "author": "Martin Lb, Claude",
    "version": (1, 7, 3),
    "blender": (4, 2, 0),
    "location": "View3D > Sidebar > SmartPath",
    "description": "Setup rapide et safe des chemins de rendu Output/EXR/CRYPTO",
    "category": "3D View",
}
...
class UPDATEPATH_OT_set_render_path(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        # Convertit le filepath en chemin absolu et résout les ..
